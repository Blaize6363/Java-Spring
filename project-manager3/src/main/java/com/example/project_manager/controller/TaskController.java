...
public class TaskController {
    ...
    @PutMapping("/{projectId}/tasks/{taskId}/assignee")
    public ResponseEntity<TaskResponseDto> assignUser(@PathVariable Long projectId, @PathVariable Long taskId, @RequestBody Long userId) {
        return ResponseEntity.ok(tasks.assignUser(projectId, taskId, userId));
    }

    @DeleteMapping("/{projectId}/tasks/{taskId}/assignee")
    public ResponseEntity<Void> removeUser(@PathVariable Long projectId, @PathVariable Long taskId) {
        tasks.removeUser(projectId, taskId);
        return ResponseEntity.noContent().build();
    }
}
