...
public class TaskRequestDto {
    ...
    public TaskRequestDto(String title, String description, TaskStatus status, TaskPriority priority, String dueDate, Long projectId, Long assignedUserId, String assignedUsername){
        this.title = title;
