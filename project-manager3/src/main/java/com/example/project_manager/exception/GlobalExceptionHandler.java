...
public class GlobalExceptionHandler{
    ...
    @ExceptionHandler(TaskProjectMismatchException.class)
    public ResponseEntity<ErrorResponse> handleTaskProjectMismatchException(TaskProjectMismatchException ex, HttpServletRequest request) {
        ErrorResponse errorResponse = new ErrorResponse(
                Instant.now(),
                HttpStatus.BAD_REQUEST,
                ex.getMessage(),
    ...
    public ResponseEntity<ErrorResponse> handleTaskAssignmentNotAllowedException(TaskAssignmentNotAllowedException ex, HttpServletRequest request) {
        ErrorResponse errorResponse = new ErrorResponse(
                Instant.now(),
                HttpStatus.CONFLICT,
                ex.getMessage(),
